...
Проект разрабатывается по этапам. Текущая ветка `feature-08-map-cluster-tuning` доводит карту до устойчивого отображения видимых кластеров и миниатюр поверх MapLibre.
