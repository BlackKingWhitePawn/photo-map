...
Проект разрабатывается по этапам. Текущая ветка `feature-04-large-gallery-performance` оптимизирует сканирование и карту для больших локальных галерей до 40 000 фотографий.
...
После первичного центрирования по всем фотографиям с координатами карта строит маркеры только для текущей видимой области. Это нужно, чтобы не рисовать десятки тысяч маркеров одновременно на больших галереях.
