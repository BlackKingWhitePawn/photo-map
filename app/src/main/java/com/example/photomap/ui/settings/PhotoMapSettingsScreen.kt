...
private fun PhotoAccessUiState.diagnosticHeader(): String {
    ...
    return buildString {
        ...
        appendLine("Visible trip heat cells: ${visibleTripHeatCells.size}")
        appendLine("Visible trip heat resolution: $visibleTripHeatResolution")
        appendLine("Trip heatmap data version: $tripHeatmapDataVersion")
